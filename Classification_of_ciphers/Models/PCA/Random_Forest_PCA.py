...
dfCIPHER = pd.read_csv(file)

# Drop the 'Plaintext' column
dfCIPHER.drop(['Plaintext','Encryption'], axis=1, inplace=True)
...
dfCIPHER['Encryption Type'].value_counts().plot(kind='barh')
...
# Define the classifier object as RandomForestClassifier
classifier = RandomForestClassifier(n_estimators=100, random_state=1)  # You can adjust n_estimators and other params
