...
# Define classifiers
svm_classifier = SVC(kernel='rbf', probability=True, class_weight='balanced', random_state=42)
rf_classifier = RandomForestClassifier(n_estimators=100, random_state=42)
xgb_classifier = XGBClassifier(eval_metric='mlogloss', random_state=42)

# Create the ensemble classifier (Voting Classifier)
...
# Model pipeline with the ensemble classifier
...
# Save model
joblib.dump(model, '../ensemble_svm_rf_xgb_tsne_model.joblib')
